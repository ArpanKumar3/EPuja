...
const navigation = [
  ...
  { name: 'Puja Management', href: 'pujas', icon: BookCopy },
        ...
        <Dialog as="div" className="relative z-40 lg:hidden" onClose={setSidebarOpen}>
          ...
          <div className="fixed inset-0 flex z-40">
            <Transition.Child as={Fragment} enter="transition ease-in-out duration-300 transform" enterFrom="-translate-x-full" enterTo="translate-x-0" leave="transition ease-in-out duration-300 transform" leaveFrom="translate-x-0" leaveTo="-translate-x-full">
              <Dialog.Panel className="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800 text-white">
...
const SidebarContent = ({ signOut }) => (
    ...
    <div className="flex items-center flex-shrink-0 px-4">
        <Link to="/admin/dashboard" className="text-3xl font-bold text-white font-heading">
            ePuja Admin
        </Link>
    </div>
